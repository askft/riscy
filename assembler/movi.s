...
movi:	lui	r1, rout			# r1 = &rout & 0xffc0
	...
	# ---------------------	r3 = &rout | 0x003f
	addi	r7, r7, 1111110			# Make room for 2 on stack
	sw	r1, r7, 0000000			# Save r1
	sw	r2, r7, 0000001			# Save r2
	nand	r3, r1, r2			# ----\
	nand	r1, r1, r2			# AND  > r3 = r1 & r2
	nand	r3, r3, r1			# ----/
	lw	r1, r7, 0000000			# Restore r1
	lw	r2, r7, 0000001			# Restore r2
	addi	r7, r7, 0000010			# Remove room for 2 on stack
